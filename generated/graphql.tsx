...
export type CreateMissingPostMutation = {
  ...
  createMissingPost: {
    ...
    post?: Maybe<{
      ...
      updatedAt: any;
      createdAt: any;
      address?: Maybe<{ __typename?: 'Address'; id: number }>;
    }>;
  };
};
...
export type MeQuery = {
  ...
  me?: Maybe<{
    ...
    provider: string;
    provider_id?: Maybe<number>;
    avatar?: Maybe<{ __typename?: 'Photo'; path: string; url?: Maybe<string> }>;
  }>;
};
 ...
 * });
 */
export function useMissingPostsQueryQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MissingPostsQueryQuery,
    MissingPostsQueryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    MissingPostsQueryQuery,
    MissingPostsQueryQueryVariables
  >(MissingPostsQueryDocument, options);
}
export function useMissingPostsQueryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MissingPostsQueryQuery,
    MissingPostsQueryQueryVariables
  >
...
export type MissingPostsQueryQueryHookResult = ReturnType<
  typeof useMissingPostsQueryQuery
>;
export type MissingPostsQueryLazyQueryHookResult = ReturnType<
  typeof useMissingPostsQueryLazyQuery
>;
export type MissingPostsQueryQueryResult = Apollo.QueryResult<
  MissingPostsQueryQuery,
  MissingPostsQueryQueryVariables
>;
