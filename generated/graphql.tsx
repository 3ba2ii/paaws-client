...
export const MissingPostsQueryDocument = gql`
    query MissingPostsQuery {
  missingPosts {
    id
    title
    description
...
/**
 * __useMissingPostsQueryQuery__
 *
 * To run a query within a React component, call `useMissingPostsQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useMissingPostsQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMissingPostsQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function useMissingPostsQueryQuery(baseOptions?: Apollo.QueryHookOptions<MissingPostsQueryQuery, MissingPostsQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MissingPostsQueryQuery, MissingPostsQueryQueryVariables>(MissingPostsQueryDocument, options);
      }
export function useMissingPostsQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MissingPostsQueryQuery, MissingPostsQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MissingPostsQueryQuery, MissingPostsQueryQueryVariables>(MissingPostsQueryDocument, options);
        }
export type MissingPostsQueryQueryHookResult = ReturnType<typeof useMissingPostsQueryQuery>;
export type MissingPostsQueryLazyQueryHookResult = ReturnType<typeof useMissingPostsQueryLazyQuery>;
export type MissingPostsQueryQueryResult = Apollo.QueryResult<MissingPostsQueryQuery, MissingPostsQueryQueryVariables>;
